...
STATUS = {
    ...
    3: "Generating",
    0x2010: "Failsafe",
    0x2011: "Meter communication failure",
    0x2012: "Battery communication failure",
    0x2019: "Meter selection failure",
}
...
REGISTERS = (
    ...
    R(
        "production_last_year",
        "PV production last year",
        33039,
        2,
        unit="kWh",
        device_class="energy",
    ...
    *(
        ...
        for phase in (1, 2)
        for kind, offset, unit in (("voltage", 0, "V"), ("current", 1, "A"))
    ),
    ...
    *(
        ...
        for kind, base, unit in (("voltage", 33073, "V"), ("current", 33076, "A"))
        for phase in (1, 2, 3)
    ),
    R(
        "inverting_power",
